...
class ArticleGenerator:
    ...
    def regenerate_article_with_new_keywords(
        ...
        optimized_content = self._optimize_content(existing_article.content, all_keywords)
    ...
    def _optimize_content(self, content: str, keywords: List[str]) -> str:
        ...
        try:
            ...
            with tempfile.NamedTemporaryFile(mode='w', suffix='.json', delete=False) as keywords_file:
                keywords_data = {
                    "keywords": [{"keyword": kw, "intent": "informational", "competition": "medium"} for kw in keywords]
                }
                import json
    ...
    def _generate_meta_description(self, title: str, main_keyword: str, content: str) -> str:
