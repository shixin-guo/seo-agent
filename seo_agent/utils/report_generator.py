...
class ReportGenerator:
    def __init__(self, config: Dict[str, Any]):
        self.config = config
        self.reports_folder = config.get('output', {}).get('reports_folder', './data/exports')
    ...
    def save_csv(self, data: List[Dict[str, Any]], base_name: str, fieldnames: Optional[List[str]] = None) -> str:
        """Save data as CSV"""
        self._ensure_reports_folder()
